        ...
        <main class="main-content">
            ...
            <div class="top-bar">
                <div class="top-bar-left">
                    <h1>Beranda</h1>
                    <p class="welcome-text">Selamat datang, <?php echo e(Auth::user()->name); ?>!</p>
                </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-number"><?php echo e($stats['total_pasien'] ?? 0); ?></div>
                    <small>Terdaftar dalam sistem</small>
                </div>
                <div class="stat-card success">
                    <div class="stat-label">Pasien Hari Ini</div>
                    <div class="stat-number"><?php echo e($stats['pasien_hari_ini'] ?? 0); ?></div>
                ...
                <div class="stat-card info">
                    ...
                    <div class="stat-number"><?php echo e($stats['kunjungan_bulan_ini'] ?? 0); ?></div>
            ...
            <div class="table-card">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $recent_pasien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pasien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($index + 1); ?></td>
                                <td><?php echo e($pasien->no_rm); ?></td>
                                <td><?php echo e($pasien->nama); ?></td>
                                <td><?php echo e($pasien->jenis_kelamin); ?></td>
                                <td><?php echo e($pasien->usia); ?> tahun</td>
                                <td><?php echo e($pasien->jenis_bayar); ?></td>
                                <td><?php echo e($pasien->created_at->format('d/m/Y')); ?></td>
                                <td>
                                    <a href="<?php echo e(route('pasien.show', $pasien->id)); ?>" class="btn btn-sm btn-info">
                ...
                <div class="pagination">
                    <div>Showing <?php echo e($recent_pasien->count()); ?> of <?php echo e($stats['total_pasien'] ?? 0); ?> entries</div>
                    <div>
                        <a href="<?php echo e(route('pasien.index')); ?>" class="btn btn-sm btn-primary">Lihat Semua Pasien</a>
                    </div>
                </div>
            </div>
            ...
            <div class="action-buttons">
                <a href="<?php echo e(route('pasien.create')); ?>" class="action-btn btn-primary">
                    <i class="fas fa-user-plus"></i>
                    Pasien Baru
                </a>
                <a href="<?php echo e(route('pasien.index')); ?>" class="action-btn btn-secondary">
                    <i class="fas fa-list"></i>
                    Daftar Pasien
                </a>
                <a href="<?php echo e(route('laboratorium.index')); ?>" class="action-btn btn-warning">
                    <i class="fas fa-flask"></i>
                    Laboratorium
                </a>
                <a href="<?php echo e(route('kasir.index')); ?>" class="action-btn btn-primary">
        ...
        const chartPasien = new Chart(ctxPasien, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'UMUM / SWASDAYA',
                        data: [<?php echo e($stats['total_pasien'] ?? 0); ?>],
                        backgroundColor: chartColors.blue,
                        borderRadius: 6
                    },
                    {
                        label: 'BPJS PBI',
                        data: [<?php echo e($stats['bpjs_pbi'] ?? 0); ?>],
                        backgroundColor: chartColors.red,
                        borderRadius: 6
                    },
                    {
                        label: 'BPJS NON PBI',
                        data: [<?php echo e($stats['bpjs_non_pbi'] ?? 0); ?>],
                        backgroundColor: chartColors.yellow,
                        borderRadius: 6
                    },
                    {
                        label: 'JAMKESDA',
                        data: [<?php echo e($stats['jamkesda'] ?? 0); ?>],
...
</html><?php /**PATH C:\Users\7HU8MIAW33\M1\resources\views/dashboard.blade.php ENDPATH**/ ?>